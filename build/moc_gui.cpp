...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_FirstClass_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_FirstClass_t qt_meta_stringdata_FirstClass = {
    {
QT_MOC_LITERAL(0, 0, 10), // "FirstClass"
QT_MOC_LITERAL(1, 11, 12), // "add_new_widg"
QT_MOC_LITERAL(2, 24, 0), // ""
QT_MOC_LITERAL(3, 25, 16) // "delete_this_abnt"

    },
    "FirstClass\0add_new_widg\0\0delete_this_abnt"
};
...
void FirstClass::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->delete_this_abnt(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject FirstClass::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FirstClass.data,
      qt_meta_data_FirstClass,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *FirstClass::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_FirstClass.stringdata))
        return static_cast<void*>(const_cast< FirstClass*>(this));
